...
Эффективный промпт, как правило, включает следующие компоненты:
 1. Цель задачи - описание требуемого результата.
 2. Контекст - дополнительная информация, уточняющая область применения.
 3. Ограничения - требования к формату, стилю, объёму или способу представления.
 4. Дополнительные указания - примеры или уточнения, влияющие на интерпретацию запроса.
...
В условиях широкого внедрения ИИ умение разрабатывать эффективные промпты становится важной профессиональной компетенцией, сопоставимой по значимости с навыками программирования и аналитического мышления.`,
      ...
      "2": {
        ...
        text: `Для повышения качества взаимодействия с системами искусственного интеллекта, целесообразно использовать структурированный подход к формированию запросов. Одной из эффективных моделей является последовательность: «Роль → Контекст → Задача → Ограничения».
